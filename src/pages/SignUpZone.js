      ...
      <main className="bg-[#38A926] md:bg-[#FFFFFF]  min-h-screen flex items-center justify-center md:pt-12  md:pb-20">
        ...
        <div className="bg-[#38A926] md:rounded-2xl flex flex-col items-center pb-20">
          ...
          <form className="self-start px-10 w-full mb-4">
            ...
            <label for="register" className="text-sm font-medium text-white dark:text-white">Register as</label>
            ...
            <select id="register"
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <label for="fname" className="text-sm font-medium  text-white dark:text-white">
                  First name
                </label>

                <input type="text" name="fname" id="fname" value={firstName} onChange={(e) => setFirstName(e.target.value)}
                  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600
            focus:border-primary-600 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your first name
            first"
                  required
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <label for="lname" className="text-sm font-medium  text-white dark:text-white">
                  Last name
                </label>
...
first"
            ...
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your email address"
                  required
                />
              </div>
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <input type="tel" name="phonenumber" id="phonenumber" value={phoneNumber} onChange={(e) =>
                  setPhoneNumber(e.target.value)}
                  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600
            focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="+234"
                  required
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <label for="password" className="text-sm font-medium text-white dark:text-white">
                  Password
                </label>
            ...
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <input type="confirm-password" name="confirm-password" id="confirm-password" value={password}
