...
const Footer = () => {
  return (
    <footer className='bg-black text-white pt-20 '>
      ...
      <div className='flex items-center justify-between gap-12 mx-auto py-6  md:w-5/6 border-primary border-b-2 border-opacity-60'>

        <div className='ml-4 sm:ml-0 flex flex-col items-start justify-between gap-4 md:gap-3'>
          ...
          <div className='flex gap-1 md:gap-3'>
            ...
            <a href="/" className="text-whitehover:text-gray-300">
          ...
          <div>
            ...
            <a href='/' className='flex text-[14px]'>
              <svg className="w-8 h-6 md:mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>
          ...
          <div>
            <a href='/' className='flex text-[14px]'>
              <svg className="w-8 h-6 md:mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" /></svg>
              +234-706-363-4744
            </a>
          </div>
      ...
      <div className='flex justify-center items-center gap-3 min-w-max mt-4 lg:hidden'>
        <a href='/'>
